...
struct LoginOneView: View {
    @StateObject var loginOneViewModel = LoginOneViewModel()
    ...
    var body: some View {
        NavigationView {
            VStack {
                        ...
                        ZStack(alignment: .bottomLeading) {
                            ...
                            VStack(alignment: .leading, spacing: 0) {
                                ...
                                Group {
                                    HStack {
                                        ...
                                        TextField(StringConstants.kMsgEnterYourUser,
                                                  text: $loginOneViewModel.textinputText)
                                            .font(FontScheme
                                    ...
                                    .onChange(of: loginOneViewModel.textinputText) { newValue in

                                        loginOneViewModel.isValidTextinputText = newValue
                                    ...
                                    if !loginOneViewModel.isValidTextinputText {
                                ...
                                Group {
                                    HStack {
                                        ...
                                        SecureField(StringConstants.kMsgEnterYourPass,
                                                    text: $loginOneViewModel.passwordoneText)
                                            .font(FontScheme
                                                .kManropeMedium(size: getRelativeHeight(14.0)))
                                            .foregroundColor(ColorConstants.Gray500)
                                            .padding()
                                    ...
                                    .onChange(of: loginOneViewModel.passwordoneText) { newValue in

                                        loginOneViewModel.isValidPasswordoneText = newValue
                                    ...
                                    .padding(.top, getRelativeHeight(6.0))
                                    .padding(.horizontal, getRelativeWidth(19.0))
                                    if !loginOneViewModel.isValidPasswordoneText {
                                ...
                                HStack {
                                    ...
                                    Text(StringConstants.kLblForgotPassword)
                                        ...
                                        .onTapGesture {
                                            loginOneViewModel
                                                .nextScreen = "ForgotandresetpasswordTwoView"
                                        }
                                }
                                ...
                                .onTapGesture {
                                    loginOneViewModel.nextScreen = "RegisterOneView"
                                }
                            ...
                            Image("img_vector_white_a700_155x158")
                                ...
                                .frame(width: getRelativeWidth(170.0),
                                       height: getRelativeHeight(168.0), alignment: .center)
                                .scaledToFit()
                                .clipped()
                ...
                Group {
                    NavigationLink(destination: RegisterOneView(),
                                   tag: "RegisterOneView",
                                   selection: $loginOneViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                    NavigationLink(destination: ForgotandresetpasswordTwoView(),
                                   tag: "ForgotandresetpasswordTwoView",
                                   selection: $loginOneViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
