...
struct OnbroadingFiveView: View {
    @StateObject var onbroadingFiveViewModel = OnbroadingFiveViewModel()
    ...
    var body: some View {
        NavigationView {
            VStack {
                VStack(alignment: .trailing, spacing: 0) {
                    ...
                    VStack {
                        HStack {
                            ...
                            .onTapGesture {
                                onbroadingFiveViewModel.nextScreen = "OnbroadingSixView"
                            }
                ...
                Group {
                    NavigationLink(destination: OnbroadingSixView(),
                                   tag: "OnbroadingSixView",
                                   selection: $onbroadingFiveViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct OnbroadingFiveView_Previews: PreviewProvider {
