...
struct OnbroadingFourView: View {
    @StateObject var onbroadingFourViewModel = OnbroadingFourViewModel()
    ...
    var body: some View {
        NavigationView {
            VStack {
                VStack(alignment: .trailing, spacing: 0) {
                    ...
                    VStack {
                        HStack {
                            ...
                            .onTapGesture {
                                onbroadingFourViewModel.nextScreen = "OnbroadingFiveView"
                            }
                ...
                Group {
                    NavigationLink(destination: OnbroadingFiveView(),
                                   tag: "OnbroadingFiveView",
                                   selection: $onbroadingFourViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
