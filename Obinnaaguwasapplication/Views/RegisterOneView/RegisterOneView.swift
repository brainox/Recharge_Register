...
struct RegisterOneView: View {
    ...
    @State private var textinputtwoText: String = ""
    @State private var textinputthreeText: String = ""
    var body: some View {
        VStack {
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    ZStack(alignment: .bottomLeading) {
                        Image("img_vector_white_a700_155x158")
                            .resizable()
                            .frame(width: getRelativeWidth(158.0), height: getRelativeHeight(155.0),
                                   alignment: .center)
                            .scaledToFit()
                            .clipped()
                        ...
                        VStack(alignment: .leading, spacing: 0) {
                            ...
                            Group {
                                Text(StringConstants.kMsgPasswordNeeds)
                                    .font(FontScheme.kManropeRegular(size: getRelativeHeight(12.0)))
                                    .fontWeight(.regular)
                                    .foregroundColor(ColorConstants.Gray500)
                                    .minimumScaleFactor(0.5)
                                    .multilineTextAlignment(.leading)
                        ...
                        Text(StringConstants.kMsgCreateYourAcc)
                            ...
                            .minimumScaleFactor(0.5)
                            .multilineTextAlignment(.leading)
                            .frame(width: getRelativeWidth(240.0), height: getRelativeHeight(33.0),
                                   alignment: .topLeading)
