...
struct OnbroadingSixView: View {
    @StateObject var onbroadingSixViewModel = OnbroadingSixViewModel()
    ...
    var body: some View {
        NavigationView {
            VStack {
                ...
                Group {
                    NavigationLink(destination: OnbroadingSevenView(),
                                   tag: "OnbroadingSevenView",
                                   selection: $onbroadingSixViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct OnbroadingSixView_Previews: PreviewProvider {
