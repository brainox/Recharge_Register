        ...
        NavigationView {
            VStack {
                VStack {
                    ...
                    .onTapGesture {
                        welcomescreenViewModel.facebookSignIn()
                    }
                    ...
                    .onTapGesture {
                        welcomescreenViewModel.googleSignIn()
                    }
                    .frame(width: getRelativeWidth(335.0), height: getRelativeHeight(52.0),
                           alignment: .center)
                    .overlay(RoundedCorners(topLeft: 15.0, topRight: 15.0, bottomLeft: 15.0,
                    ...
                    .onTapGesture {
                        welcomescreenViewModel.appleSignIn()
                    }
                    .frame(width: getRelativeWidth(335.0), height: getRelativeHeight(52.0),
                           alignment: .center)
                    .overlay(RoundedCorners(topLeft: 15.0, topRight: 15.0, bottomLeft: 15.0,
                    ...
                    .onTapGesture {
                        welcomescreenViewModel.nextScreen = "RegisterOneView"
                    }
